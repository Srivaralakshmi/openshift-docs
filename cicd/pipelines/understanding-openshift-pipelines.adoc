...
//About final tasks
include::modules/op-about-finaltasks.adoc[leveloffset=+2]
//About task run
...
* For more details on the final tasks and how to add them to the Pipeline, see the link:https://github.com/tektoncd/pipeline/blob/main/docs/pipelines.md#adding-finally-to-the-pipeline[Adding Finally to the Pipeline] section in the GitHub documentation for Pipelines.
